    ...
    "apis": [
        ...
        {
            "SceneProductController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_products\",\"foreignKeyName\":\"uuid\",\"options\":{\"find\":{\"auth\":false},\"findAll\":{\"auth\":false},\"create\":{\"auth\":false,\"properties\":[\"mesh_uuid\",\"product_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":false,\"properties\":[\"mesh_uuid\",\"product_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":false}}}"
        },
        {
