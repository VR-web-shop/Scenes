    ...
    "apis": [
        ...
        {
            "MeshController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/meshes\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"name\",\"source\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"source\"]},\"delete\":{\"auth\":true}}}"
        },
        {
        ...
        {
            "SceneBackgroundController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_backgrounds\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"hex\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"hex\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneBasketController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_baskets\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"object_offset_uuid\",\"object_uuid\",\"placeholder_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"object_offset_uuid\",\"object_uuid\",\"placeholder_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
        ...
        {
            "SceneCheckoutController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_checkouts\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"name\",\"surface_offset_uuid\",\"surface_size_uuid\",\"ui_offset_uuid\",\"ui_rotation_uuid\",\"mesh_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"surface_offset_uuid\",\"surface_size_uuid\",\"ui_offset_uuid\",\"ui_rotation_uuid\",\"mesh_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneProductController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_products\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"state_name\",\"mesh_uuid\",\"product_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"state_name\",\"mesh_uuid\",\"product_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scenes\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":false},\"create\":{\"auth\":true,\"properties\":[\"name\",\"description\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"description\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneFloorController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_floors\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"name\",\"mesh_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"mesh_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneLightController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_lights\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"name\",\"intensity\",\"hexColor\",\"scene_light_type_name\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"intensity\",\"hexColor\",\"scene_light_type_name\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "SceneLightTypeController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_light_types\",\"foreignKeyName\":\"name\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true}}}"
        },
        {
            "SceneStaticObjectController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/scene_static_objects\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":true,\"properties\":[\"name\",\"mesh_uuid\",\"scene_uuid\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"mesh_uuid\",\"scene_uuid\"]},\"delete\":{\"auth\":true}}}"
        },
        {
            "ProductController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/products\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":false,\"properties\":[\"name\",\"description\"]},\"update\":{\"auth\":true,\"properties\":[\"name\",\"description\",\"position_uuid\",\"rotation_uuid\",\"scale_uuid\",\"mesh_uuid\"]},\"delete\":{\"auth\":false}}}"
        },
        {
            "ProductEntityController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/product_entities\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true},\"create\":{\"auth\":false,\"properties\":[\"product_uuid\",\"product_entity_state_name\"]},\"update\":{\"auth\":false,\"properties\":[\"product_uuid\",\"product_entity_state_name\"]},\"delete\":{\"auth\":false}}}"
        },
        {
            "ProductEntityStateController": "{\"serverURL\":\"http://http://localhost:3003\",\"endpoint\":\"/api/v1/product_entity_states\",\"foreignKeyName\":\"uuid\",\"options\":{\"authorization\":{\"storage\":\"localStorage\",\"key\":\"auth\"},\"find\":{\"auth\":true},\"findAll\":{\"auth\":true}}}"
        },
        {
