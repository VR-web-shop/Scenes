...
import ReadCollectionMysqlQuery from '../../../queries/Material/ReadCollectionQuery.js';
...
router.route('/api/v1/admin/health')
    ...
    .get(async (req, res) => {
        try {
            ...
            try {
                await queryService.invoke(new ReadCollectionMysqlQuery({
                    limit: 10, page: 1
                }))
