...
import ReadOneQuery from '../../../queries/MeshMaterial/ReadOneQuery.js';
import ReadCollectionQuery from '../../../queries/MeshMaterial/ReadCollectionQuery.js';
...
router.route('/api/v1/mesh_materials')
     ...
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("mesh-materials:index"), async (req, res) => {
        try {
     ...
     *  description: Internal Server Error
     */
    router.post(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT('mesh-materials:put'), async (req, res) => {
        try {
...
router.route('/api/v1/mesh_material/:client_side_uuid')
     ...
     *        description: Internal Server Error
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("mesh-materials:show"), async (req, res) => {
        try {
    ...
    *        description: Internal Server Error
    */
    .patch(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("mesh-materials:put"), async (req, res) => {
        try {
            const { client_side_uuid } = req.params
    ...
    *        description: Internal Server Error
    */
    .delete(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("mesh-materials:delete"), async (req, res) => {
        try {
            const { client_side_uuid } = req.params
