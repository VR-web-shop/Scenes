...
import ReadOneQuery from '../../../queries/SceneLightType/ReadOneQuery.js';
import ReadCollectionQuery from '../../../queries/SceneLightType/ReadCollectionQuery.js';
...
router.route('/api/v1/scene_light_types')
     ...
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("scene-light-types:index"), async (req, res) => {
        try {
...
router.route('/api/v1/scene_light_type/:name')
     ...
     *        description: Internal Server Error
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("scene-light-types:show"), async (req, res) => {
        try {
