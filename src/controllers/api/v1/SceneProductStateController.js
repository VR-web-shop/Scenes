...
import ReadOneQuery from '../../../queries/SceneProductState/ReadOneQuery.js';
import ReadCollectionQuery from '../../../queries/SceneProductState/ReadCollectionQuery.js';
...
router.route('/api/v1/scene_product_states')
     ...
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("scene-product-states:index"), async (req, res) => {
        try {
...
router.route('/api/v1/scene_product_state/:name')
     ...
     *        description: Internal Server Error
     */
    .get(Middleware.AuthorizeJWT, Middleware.AuthorizePermissionJWT("scene-product-states:show"), async (req, res) => {
        try {
